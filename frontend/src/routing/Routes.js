...
import Conference from "../components/project/conference/conference";
import Resumeanalyzer from "../components/project/conference/resumeanalyzer";
    ...
    return (
        <Fragment>
            <Switch>
                ...
                <PrivateRoute exact path="/conferencing" component={ Conference } />
                <PrivateRoute exact path="/resumeanalyzer" component={ Resumeanalyzer } />
