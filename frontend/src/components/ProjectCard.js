...
const ProjectCard = ({ project, noImage, noMember }) => {
    ...
    return (
     ...
     >
         <div>
             <h3 className="text-lg font-bold text-orange-500 sm:text-xl overflow-hidden text-ellipsis"> App Development </h3>

             <p className="mt-1 text-xs font-medium text-white-light"> Deepshika Agarwal </p>
         </div>

         <div className="mt-4">
             <p className="max-w-[40ch] text-sm text-white-light"> Create app for student benefit </p>
         </div>

         <dl className="mt-6 flex items-center justify-self-auto gap-4 sm:gap-6">
             <div className="flex flex-col-reverse items-center justify-center">
                 <dt className="text-sm font-medium text-white-light">Deadline</dt>
                 <dd className="text-xs text-white-light"> 12-03-1024 </dd>
             </div>

             <div className="flex flex-col-reverse items-center justify-center">
                 <dt className="text-sm font-medium text-white-light">Discussion</dt>
                 <dd className="text-xs text-white-light">2</dd>
             </div>

             <div className="flex flex-col-reverse items-center justify-center">
                 <dt className="text-sm font-medium text-white-light"> Bug </dt>
                 <dd className="text-xs text-white-light"> 8 </dd>
             </div>

             <div className="flex flex-col-reverse items-center justify-center">
                 <dt className="text-sm font-medium text-white-light">Todo </dt>
                 <dd className="text-xs text-white-light"> 4 </dd>
             </div>

             <div className="flex flex-col-reverse items-center justify-center">
                 <dt className="text-sm font-medium text-white-light"> Member </dt>
                 <dd className="text-xs text-white-light"> 5</dd>
             </div>
         </dl>
         ...
         <div className="flex items-center justify-between mt-7 w-full">
             ...
             >
                 ...
                 <span className="text-[10px] font-medium sm:text-xs"> 0 </span>
             </strong>
         </div>
     </Link>
     </>
